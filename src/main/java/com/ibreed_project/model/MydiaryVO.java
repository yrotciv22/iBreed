...
public class MydiaryVO {
	...
	public MultipartFile  getDiary_profile_image() {
		return diary_profile_image;
	}

	public void setDiary_profile_image(MultipartFile diary_profile_image) {
		this.diary_profile_image = diary_profile_image;
	}

	public String getDiary_profile_image_path() {
		return diary_profile_image_path;
	}

	public void setDiary_profile_image_path(String diary_profile_image_path) {
		this.diary_profile_image_path = diary_profile_image_path;
	}

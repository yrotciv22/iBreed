					...
					<div class="button_wrap">
						<div class="select_all">
							<label class="custom-checkbox"> <input type="checkbox"
								id="select_all" /> <span class="checkmark"></span>
							...
							<div class="one_item_wrap">
								...
								<div class="prd_image">
									...
									<c:if test="${cart.product_stock eq 0}">
										<div class="sold_out_tag">품 절</div>
									</c:if>
									<c:if
										test="${cart.product_stock gt 0 and cart.product_stock lt 10}">
										<div class="sold_out_tag">품절 임박</div>
									</c:if>
								...
								<div style="height: 100%;">
									<div class="column_wrap" style="width: 530px;">
										...
										<input type="hidden" name="product_name"
											...
											type="hidden" name="product_discount"
